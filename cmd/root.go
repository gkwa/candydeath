...
import (
	...
	"github.com/gkwa/candydeath/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.candydeath.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".candydeath")
	}
